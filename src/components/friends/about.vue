    ...
    <div class="katn9ffz">
        ...
        <div class="book-card">
                ...
                <el-tabs v-model="tabs2">
                    <el-tab-pane :label="me_ul.name+'的相册'" name="1"></el-tab-pane>
        ...
        <div class="book-card">
                <div class="book-title2">视频</div>
                 <el-tabs v-model="tabs3">
                    <el-tab-pane :label="me_ul.name+'的视频'" name="1"></el-tab-pane>
                </el-tabs>
